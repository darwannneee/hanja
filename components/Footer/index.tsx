    ...
    return (
        <footer className="bg-[rgb(27,77,137)] text-[#faf6e5] px-14 py-5 ">
            ...
            <div className={`pt-12 grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center ${FutureStdBook.className}`}>
                <input type="text" className="border-[#faf6e5] border-2 bg-[rgb(27,77,137)] w-full max-w-md h-10 text-[#faf6e5] pl-2" placeholder="Name"/>
                <input type="text" className="border-[#faf6e5] border-2 bg-[rgb(27,77,137)] w-full max-w-md h-10 text-[#faf6e5] pl-2" placeholder="Phone Number"/>
                <input type="text" className="border-[#faf6e5] border-2 bg-[rgb(27,77,137)] w-full max-w-md h-10 text-[#faf6e5] pl-2" placeholder="Email"/>
            </div>
